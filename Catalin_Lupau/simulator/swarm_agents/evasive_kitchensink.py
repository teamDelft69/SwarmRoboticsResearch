...
class EvasiveKitchensinkBoids(SteerAwayDirectedWhirlwindRepulsiveBoids):
  """
  ...
  def _compute_velocity(self, current_tick: int, delta_time: float, agent_perception: AgentPerception):
    self.velocity += self._compute_centering_velocity(current_tick, delta_time, agent_perception) + self._compute_avoidance_velocity(
        ...
        + self._compute_evasive_velocity(current_tick,
                                         delta_time, agent_perception) + self._compute_obstacle_avoidance_velocity(current_tick, delta_time, agent_perception)
